...
router.post('/register', async (req, res) => {
  try {
    ...
    // FIX: Removed console.log that leaked plaintext passwords
    ...
    // FIX: Strip password hash before sending response
    ...
    // FIX: Removed databaseError: error.message from response
...
router.post('/login', async (req, res) => {
  try {
    ...
    // FIX: Changed from 365d to 7d — reasonable and secure expiry
    ...
    // FIX: Removed errorStack: error.stack from response
